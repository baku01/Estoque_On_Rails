...
ActiveRecord::Schema[7.1].define(version: 2024_02_10_234934) do
  ...
  create_table "requisicaos", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["estoque_id"], name: "index_requisicaos_on_estoque_id"
  end
  ...
  add_foreign_key "requisicaos", "estoques"
end
